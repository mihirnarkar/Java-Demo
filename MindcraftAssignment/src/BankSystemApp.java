    ...
    public void login() throws SQLException {
        ...
        if (result.next()) {
            ...
            while (true) {
                ...
                switch (adminChoice) {
                    case 1:
                    	System.out.println("Ok, lets add the customer");
                        addCustomer();
                        break;
                    case 2:
                    	System.out.println("Lets start with your searching:))");
                        searchCustomer();
                        break;
                    case 3:
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                    	System.out.println("Lets do the balance enquiry ");
                        balanceEnquiry();
                        break;
                    case 6:
                    	System.out.println(adminUsername+" Logging you out");
                    	System.out.println("Thank you...");
                    	con.close();
                    	System.exit(0);
                    default:
